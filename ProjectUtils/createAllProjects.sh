...
./prepareProject.sh GameEngineTests $GameEngineTestsId Application GameEngine Input DirectXApi OpenGLApi GraphicsApi Utils UtilsNetwork Common > ../Sources/GameEngineTests/GameEngineTests.vcxproj