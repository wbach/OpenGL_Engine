...
#GUID (or UUID) generator: https://www.guidgenerator.com/online-guid-generator.aspx
GraphicsApiId='{c84bf5e8-9a00-48fa-8465-4f55bbeaa7d6}'
DirectXApiId='{e2cc3475-9000-4c81-873f-fd93d925e34a}'
VulkanApiId='{46ab2afe-0db0-4c1a-99d7-96f374b73076}'
...
./prepareSolution.sh 'DirectXApi':$DirectXApiId:$GraphicsApiId:$utilsId 'GraphicsApi':$GraphicsApiId::$InputId 'Input':$InputId 'OpenGLApi':$OpenGlApiId:$GraphicsApiId:$utilsId 'VulkanApi':$VulkanApiId::$GraphicsApiId:$utilsId 'RpgGameServer:'$RpgGameServerId':'$utilsId:$utilsNetworkId:$CommonId 'UtilsNetwork':$utilsNetworkId:$utilsId 'Utils:'$utilsId 'GameEngine:'$gameEngineId':'$utilsId 'Game':$GameId':'$gameEngineId:$VulkanApiId:$DirectXApiId:$OpenGlApiId:$InputId:$utilsId:$utilsNetworkId:$CommonId:$GraphicsApiId 'WxEditor':$WxEditorId':'$gameEngineId:$DirectXApiId:$VulkanApiId:$OpenGlApiId:$InputId:$utilsId:$utilsNetworkId:$CommonId:$GraphicsApiId 'Tests:'$TestsId':'$gameEngineId 'Common':$CommonId:$utilsId > ../Solutions/VisualStudio/GameEngine.sln

echo "Generate VisualStudio VulkanApi project"
./prepareProject.sh VulkanApi $VulkanApiId StaticLibrary > ../Sources/VulkanApi/VulkanApi.vcxproj
...
./prepareProject.sh Game $GameId Application GameEngine Input VulkanApi DirectXApi OpenGLApi GraphicsApi Utils UtilsNetwork Common > ../Sources/Game/Game.vcxproj

echo "Generate VisualStudio WxEditor project"
./prepareProject.sh WxEditor $WxEditorId Application GameEngine Input VulkanApi DirectXApi OpenGLApi GraphicsApi Utils UtilsNetwork Common > ../Sources/WxEditor/WxEditor.vcxproj

echo "Generate VisualStudio RpgGameServer project"
./prepareProject.sh RpgGameServer $RpgGameServerId Application Utils UtilsNetwork Common > ../Sources/RpgGameServer/RpgGameServer.vcxproj
