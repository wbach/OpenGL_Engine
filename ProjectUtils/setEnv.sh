...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:"$USERROOT/lib":"$USERROOT/lib64":"$USERROOT/usr/lib/x86_64-linux-gnu":"$USERROOT/usr/lib/x86_64-linux-gnu/pulseaudio/":"$USERROOT/usr/lib/"
