...
extern const std::string CSTR_COMPONENT_CAPSULESHAPE;
...
extern const std::string CSTR_WEAPON_BONE_ROTATION_OFFSET;
...
extern const std::string CSTR_NORMALS;
extern const std::string CSTR_COLORS;
extern const std::string CSTR_SIZE_AND_ROTATION;
...
extern const std::string CSTR_MOVEBACKWARD_ANIMATION;
