...
namespace GameEngine
{
	...
	public:
		...
		virtual bool CheckActiveWindow() override { return true; }
		virtual void ShowCursor(bool show) override {}
		virtual std::shared_ptr<InputManager> CreateInput() override { return dummyInputManagerPtr_; }
		virtual double GetTime() override {	time += 0.1f; return time;	}
