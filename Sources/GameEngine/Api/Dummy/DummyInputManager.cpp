...
namespace GameEngine
{
	...
	bool GameEngine::DummyInputManager::GetMouseKey(KeyCodes::Type) { return false; }

	vec2 GameEngine::DummyInputManager::CalcualteMouseMove() { return vec2(); }

	vec2 GameEngine::DummyInputManager::GetMousePosition() { return vec2(); }
