...
static const uint32 PER_FRAME_BIND_LOCATION            = 1;
static const uint32 PER_OBJECT_CONSTANTS_BIND_LOCATION = 2;
static const uint32 PER_OBJECT_UPDATE_BIND_LOCATION    = 3;
