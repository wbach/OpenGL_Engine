...
public:
    ...
    virtual Texture* CreateTexture(const std::string& name, vec2ui size, void* data)        = 0;
    ...
    virtual void CreateHeightMap(const std::string& input, const std::string& output, const vec3&)         = 0;
