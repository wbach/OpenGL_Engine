...
class DisarmedRotateState
    : public RotateStateBase,
      public Utils::StateMachine::Will<
          ...
          Utils::StateMachine::On<MoveLeftEvent, Utils::StateMachine::TransitionTo<DisarmedWalkAndRotateState>>,
          Utils::StateMachine::On<MoveRightEvent, Utils::StateMachine::TransitionTo<DisarmedWalkAndRotateState>>,
