...
class DrawArrowCrouchWalkState
    : public DrawArrowStateBase,
      ...
      public Utils::StateMachine::Will<
          ...
          Utils::StateMachine::On<RotateLeftEvent, Utils::StateMachine::TransitionTo<DrawArrowCrouchWalkAndRotateState>>,
          Utils::StateMachine::On<RotateRightEvent, Utils::StateMachine::TransitionTo<DrawArrowCrouchWalkAndRotateState>>,
          Utils::StateMachine::On<RotateTargetEvent, Utils::StateMachine::TransitionTo<DrawArrowCrouchWalkAndRotateState>>,
...
public:
    ...
    void onEnter(ArmedCrouchWalkState&, const DrawArrowEvent&);
