...
class IdleArmedChangeState
    : public ArmedChangeStateBase,
      ...
      public Utils::StateMachine::Will<
          ...
          Utils::StateMachine::On<MoveLeftEvent, Utils::StateMachine::TransitionTo<WalkArmedChangeState>>,
          Utils::StateMachine::On<MoveRightEvent, Utils::StateMachine::TransitionTo<WalkArmedChangeState>>,
