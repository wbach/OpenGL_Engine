...
class ArmedIdleState
    : public IdleStateBase,
      public Utils::StateMachine::Will<
          ...
          Utils::StateMachine::On<RunLeftEvent, Utils::StateMachine::TransitionTo<ArmedRunState>>,
          Utils::StateMachine::On<RunRightEvent, Utils::StateMachine::TransitionTo<ArmedRunState>>,
          Utils::StateMachine::On<WalkLeftEvent, Utils::StateMachine::TransitionTo<ArmedWalkState>>,
          Utils::StateMachine::On<WalkRightEvent, Utils::StateMachine::TransitionTo<ArmedWalkState>>,
