...
bool RotatingMoveAndRotateStateBase::leaveCondition(const EndForwardMoveEvent &e)
{
    return RotatingMoveState::leaveCondition(e);
}

bool RotatingMoveAndRotateStateBase::leaveCondition(const EndBackwardMoveEvent &e)
{
    return RotatingMoveState::leaveCondition(e);
}
