...
class ArmedAttackAndRunAndRotateState
    : public AttackStateBase,
      ...
      public Utils::StateMachine::Will<
          ...
          Utils::StateMachine::On<EndRotationEvent, Utils::StateMachine::TransitionTo<ArmedAttackAndRunState>>,
          Utils::StateMachine::On<EndAttackEvent, Utils::StateMachine::TransitionTo<ArmedRunAndRotateState>>>
{
public:
    ArmedAttackAndRunAndRotateState(FsmContext&);
