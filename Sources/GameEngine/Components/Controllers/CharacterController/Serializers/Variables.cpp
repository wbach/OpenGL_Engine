...
const std::string CSTR_DIALOG                    = "dialog";
const std::string CSTR_DIALOG_SAY                = "say";
const std::string CSTR_DIALOG_LISTEN             = "listen";
...
const std::string CSTR_ANIMATION_DODGE_DIVE      = "dodgeDive";
const std::string CSTR_ANIMATION_DODGE           = "dodge";
