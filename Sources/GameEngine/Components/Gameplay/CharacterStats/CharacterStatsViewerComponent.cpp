#include "CharacterStatsViewerComponent.h"
...
{
REGISTER_COMPONENT(CharacterStatsViewerComponent)
...
void CharacterStatsViewerComponent::ReqisterFunctions()
{
    RegisterFunction(FunctionType::Awake,
                     [this]()
                     {
                         characterStats = thisObject_.GetComponent<CharacterStatsComponent>();
                         initGui();
                     });
...
void CharacterStatsViewerComponent::initGui()
{
    ...
    {
        LOG_WARN << "characterStats not found";
        return;
    }
