...
Renderer::Renderer()
    ...
    , preset{PresetSettings::Ultra,
             {PresetSettings::UltraLow, PresetSettings::Low, PresetSettings::Medium, PresetSettings::High,
              PresetSettings::VeryHigh, PresetSettings::Ultra}}
        ...
        [this]()
        {
            switch (preset)
            {
                case PresetSettings::UltraLow:
                    ...
                    textures.maxClusterSize         = vec2ui(32, 32);
                ...
                case PresetSettings::Low:
                    ...
                    textures.maxClusterSize         = vec2ui(64, 64);
                    textures.useNormal              = false;
                    flora.isEnabled                 = false;
                    flora.viewDistance              = 0.f;
                    normalMappingDistance           = 0.f;
                ...
                case PresetSettings::Medium:
                    ...
                    textures.maxClusterSize         = vec2ui(128, 128);
                    flora.isEnabled                 = false;
                    flora.viewDistance              = 0.f;
                ...
                case PresetSettings::High:
                    ...
                    normalMappingDistance           = 100.f;
                    particles.useParticles          = true;
                    water.type                      = GameEngine::Params::WaterType::FULL;
                    water.renderDistance            = 0.f;
                    water.waterReflectionResolution = vec2ui(256, 256);
                    water.waterRefractionResolution = vec2ui(256, 256);
                ...
                case PresetSettings::Ultra:
                    ...
                    textures.maxClusterSize         = vec2ui(8192, 8192);
                    flora.isEnabled                 = true;
