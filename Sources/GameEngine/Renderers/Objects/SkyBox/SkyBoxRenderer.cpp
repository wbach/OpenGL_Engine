...
namespace GameEngine
{
	...
	void SkyBoxRenderer::Subscribe(CGameObject *gameObject)
	{
	...
	void SkyBoxRenderer::LoadModel(CResourceManager& resource_manager)
	{
		if (model != nullptr)
			return;
	...
	void SkyBoxRenderer::CreateDayTextures(CResourceManager& resource_manager)
	{
	...
	void SkyBoxRenderer::CreateNightTextures(CResourceManager& resource_manager)
	{
