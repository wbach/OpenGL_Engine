...
public:
    ...
    virtual ID CreateTexture(TextureType, TextureFilter, TextureMipmap, const vec2ui&, const void*) = 0;
    virtual ID CreateTextureStorage(TextureType, TextureFilter, int32 N)                            = 0;
    virtual ID CreateCubMapTexture(vec2ui, std::vector<void*>)                                      = 0;
    virtual void UpdateTexture(uint32, const vec2ui&, const vec2ui&, const void*)                   = 0;
    virtual void UpdateTexture(uint32, const vec2ui&, const void*)                                  = 0;
