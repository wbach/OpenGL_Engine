...
public:
    ...
    MOCK_METHOD2(LoadTexture, Texture*(const File&, const TextureParameters&));
    MOCK_METHOD2(LoadCubeMap, Texture*(const std::array<File, 6>&, const TextureParameters&));
    MOCK_METHOD2(LoadHeightMap, Texture*(const File&, const TextureParameters&));
    MOCK_METHOD2(CreateNormalMap, Texture*(const HeightMap&, const vec3&));
    MOCK_METHOD0(GetGraphicsApi, GraphicsApi::IGraphicsApi&());
    MOCK_CONST_METHOD5(SaveTextureToFile, void(const File&, const std::vector<uint8>&, const TextureSize&,
