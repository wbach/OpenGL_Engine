...
void prepareState(CharacterControllerTests& test)
{
    ...
    test.tiggerAndExpect<CrouchChangeStateEvent>({test.sut_.animationClipsNames_.armed.crouch.forward});
}
}  // namespace
...
{
    prepareState(*this);
    tiggerAndExpect<CrouchChangeStateEvent>({sut_.animationClipsNames_.armed.run.forward});
}
...
TEST_F(CharacterControllerTests, ArmedCrouchWalkState_MoveBackwardEvent)
{
    ...
    expectForwardVelocity(-DEFAULT_WALK_SPEED);
    tiggerAndExpect<EndForwardMoveEvent>({sut_.animationClipsNames_.armed.crouch.forward});
...
{
    prepareState(*this);
    tiggerAndExpect<EndForwardMoveEvent>({sut_.animationClipsNames_.armed.crouchIdle});
}
