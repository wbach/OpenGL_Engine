...
TEST_F(CharacterControllerTests, DisarmedAttackState_CrouchChangeStateEvent)
{
    ...
    tiggerAndExpect<CrouchChangeStateEvent>({sut_.animationClipsNames_.equip}, {ADVANCED_TIME_TRANSITION_TIME});
...
TEST_F(CharacterControllerTests, DisarmedAttackState_MoveForwardEvent_walk)
{
    ...
    tiggerAndExpect<MoveForwardEvent>({sut_.animationClipsNames_.disarmed.movement.walk.forward, clip.name});
    expectRootboneRotation(VECTOR_FORWARD);
}
...
TEST_F(CharacterControllerTests, DisarmedAttackState_MoveForwardEvent_run)
{
    ...
    expectForwardVelocity(DEFAULT_RUN_SPEED);
    tiggerAndExpect<MoveForwardEvent>({sut_.animationClipsNames_.disarmed.movement.run.forward, clip.name});
    expectRootboneRotation(VECTOR_FORWARD);
}
