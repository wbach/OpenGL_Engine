...
void prepareState(CharacterControllerTests& test)
{
    ...
    test.tiggerAndExpect<CrouchChangeStateEvent>(
        {test.sut_.animationClipsNames_.recoilArrow, test.sut_.animationClipsNames_.armed.crouch.forward});
}
}  // namespace
...
TEST_F(CharacterControllerTests, RecoilCrouchWalk_MoveBackwardEvent)
{
    ...
    tiggerAndExpect<MoveBackwardEvent>(
        {sut_.animationClipsNames_.recoilArrow, sut_.animationClipsNames_.armed.crouchIdle});
}
...
TEST_F(CharacterControllerTests, RecoilCrouchWalk_RunBackwardEvent)
{
    ...
    tiggerAndExpect<EndForwardMoveEvent>(
        {sut_.animationClipsNames_.recoilArrow, sut_.animationClipsNames_.armed.crouch.backward});
}
...
TEST_F(CharacterControllerTests, RecoilCrouchWalk_EndBackwardMoveEvent)
{
    ...
    tiggerAndExpect<EndBackwardMoveEvent>(
                {sut_.animationClipsNames_.recoilArrow, sut_.animationClipsNames_.armed.crouchIdle}, {0});
}
TEST_F(CharacterControllerTests, RecoilCrouchWalk_ReloadArrowEventWhenRunLeftAndRight)
{
    ...
    tiggerAndExpect<MoveLeftEvent>(
        {sut_.animationClipsNames_.recoilArrow, sut_.animationClipsNames_.armed.crouch.moveleft});
    expectNoMove();
    tiggerAndExpect<MoveRightEvent>(
                {sut_.animationClipsNames_.recoilArrow, sut_.animationClipsNames_.armed.crouchIdle}, {0});
    expectNoMove();
    tiggerAndExpect<ReloadArrowEvent>(
        {sut_.animationClipsNames_.drawArrow, sut_.animationClipsNames_.armed.crouchIdle}, {0});
}
