...
void prepareState(CharacterControllerTests& test)
{
    ...
    test.tiggerAndExpect<WeaponStateEvent, RotateArmedChangeState>(
        {test.sut_.animationClipsNames_.disarmed.rotateLeft, test.sut_.animationClipsNames_.equip});
}
}  // namespace
...
{
    prepareState(*this);
    expectRotationLeft(ADVANCED_TIME_CLIP_TIME + ADVANCED_TIME_TRANSITION_TIME);
...
TEST_F(CharacterControllerTests, RotateArmedChangeState_RotateLeftEvent)
{
    ...
    tiggerAndExpect<RotateLeftEvent, RotateArmedChangeState>(
        {sut_.animationClipsNames_.equip, sut_.animationClipsNames_.disarmed.rotateLeft});
}
