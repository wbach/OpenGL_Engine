...
{
// clang-format off
const std::unordered_map<GraphicsApi::Shaders, GraphicsApi::ShadersFiles> simpleDeprecetedShaders =
{
    {
        GraphicsApi::Shaders::Loading,
        {
            {"Game/glsl_1.0p/loadingShader.vert", GraphicsApi::ShaderType::VERTEX_SHADER},
            {"Game/glsl_1.0p/loadingShader.frag", GraphicsApi::ShaderType::FRAGMENT_SHADER}
        }
    },
    {
...
GraphicsApi::ShadersFiles GetSimpleDeprecetedShaders(GraphicsApi::Shaders shaderType)
{
